  ...
  return (
    <div className="relative bg-[#0D0F13] border border-neutral-800 overflow-hidden">
      <div className="flex items-center justify-between px-4 py-2 border-b border-neutral-800">
        ...
        <button
          onClick={handleCopy}
          className="text-neutral-400 hover:text-[#76B900] transition-colors cursor-pointer"
        >
          {copied ? (
...
const EndpointCard = ({ method, path, description, children }) => {
  ...
  return (
    <div className="border border-neutral-800 p-4 sm:p-6 mb-6 sm:mb-8">
      <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
        ...
        <div className="flex-1">
          <code className="text-xs sm:text-sm text-neutral-300 break-all">
            {path}
          </code>
    ...
    <table className="w-full text-xs sm:text-sm">
      <thead>
        <tr className="border-b border-neutral-800">
          <th className="text-left py-2 px-2 sm:px-3 text-neutral-400 font-medium">
            Parameter
          </th>
          <th className="text-left py-2 px-2 sm:px-3 text-neutral-400 font-medium">
            Type
      ...
      <tbody>
        {params.map((param, i) => (
          <tr key={i} className="border-b border-neutral-800/50">
            <td className="py-2 sm:py-3 px-2 sm:px-3 font-mono text-xs text-[#76B900]">
              {param.name}
            </td>
            <td className="py-2 sm:py-3 px-2 sm:px-3 text-neutral-400">
              {param.type}
            </td>
...
const QuickStatCard = ({ icon, label, value }) => (
  <div className="border border-neutral-800 p-3 sm:p-4 bg-[#0D0F13]">
    <div className="flex items-center gap-2 mb-2 text-[#76B900]">
      {icon}
      <span className="text-xs font-medium">{label}</span>
    </div>
    <div className="text-xl sm:text-2xl font-light">{value}</div>
  </div>
);
...
export default function ApiDocs() {
    ...
    <div className="min-h-screen bg-[#0B0D10] text-[#F5F7FA]">
      ...
      <div className="pt-16 w-full">
        <div className="flex flex-col lg:flex-row">
              ...
              <div className="flex space-x-4">
                {sections.map((section) => (
                  <button
                    ...
                    className="text-xs text-neutral-400 hover:text-[#76B900] transition-colors whitespace-nowrap px-2 py-1"
                  >
                    {section.label}
                  </button>
                ))}
              ...
              <nav className="space-y-1">
                {sections.map((section) => (
                  <button
                    key={section.id}
                    onClick={() => scrollToSection(section.id)}
                    className="block w-full text-left px-3 py-2 text-sm text-neutral-400 hover:text-[#76B900] transition-colors cursor-pointer"
                  >
                    {section.label}
                  </button>
                ))}
          ...
          {/* Main Content */}
          <main className="flex-1 px-4 sm:px-6 lg:px-8 xl:px-12 py-8 lg:py-12">
            <div className="flex flex-col xl:flex-row gap-8">
              <div className="flex-1 max-w-4xl">
                {/* Introduction */}
                <section
                  id="introduction"
                  className="mb-12 lg:mb-20 scroll-mt-20"
                >
                  <h1 className="text-3xl sm:text-4xl font-light mb-4 sm:mb-6">
                    API Documentation
                  </h1>
                  <p className="text-neutral-400 text-base sm:text-lg mb-6 sm:mb-8 leading-relaxed">
                    BitLink provides a RESTful API for programmatic link
                    creation, management, and analytics. All endpoints return
                    JSON and use standard HTTP response codes.
                  </p>
                ...
                >
                  ...
                  <p className="text-neutral-400 mb-4 sm:mb-6 leading-relaxed">
                    BitLink uses JWT tokens for authentication. Include your
                    token in the Authorization header for all authenticated
                    requests.
                  </p>

                  <h3 className="text-lg sm:text-xl font-medium mb-3 sm:mb-4 text-neutral-300">
                    Login
                  </h3>
                  <CodeBlock
                    language="bash"
  ...
  -d '{
    ...
    "password": "your_password"
                  ...
                  <h3 className="text-lg sm:text-xl font-medium mb-3 sm:mb-4 mt-6 sm:mt-8 text-neutral-300">
                    Using the Token
                  </h3>
                  <CodeBlock
                    language="bash"
  ...
  -H "Authorization: Bearer YOUR_JWT_TOKEN"`}
                  ...
                  <div className="border border-orange-400/20 bg-orange-400/5 p-3 sm:p-4 mt-4 sm:mt-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-neutral-400">
                          JWT tokens expire after 7 days. Store them securely
                          and refresh before expiration to maintain access.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                {/* Links Endpoints */}
                <section id="links" className="mb-12 lg:mb-20 scroll-mt-20">
                  <h2 className="text-2xl sm:text-3xl font-light mb-4 sm:mb-6 flex items-center gap-3">
                    <Link2 className="w-5 h-5 sm:w-7 sm:h-7 text-[#76B900]" />
                    Link Management
                  </h2>
                    ...
                    <ParamTable
                      params={[
                        ...
                        },
                        {
                          ...
                          required: false,
                          description:
                            "Custom short code (alphanumeric, unique)",
                        },
                      ]}
                    />
                    <h4 className="text-sm font-medium mb-3 mt-4 sm:mt-6 text-neutral-300">
                      Response (201)
                    </h4>
                    <CodeBlock
                      language="json"
  ...
  "qrCode": "data:image/png;base64,iVBORw0KGgoAAAANS..."
                    ...
                    />
                    <div className="border border-neutral-800 p-3 sm:p-4 mt-4 bg-[#0D0F13]">
  ...
  "migratedCount": 1
                ...
                {/* Analytics */}
                <section id="analytics" className="mb-12 lg:mb-20 scroll-mt-20">
                  <h2 className="text-2xl sm:text-3xl font-light mb-4 sm:mb-6 flex items-center gap-3">
                    <BarChart3 className="w-5 h-5 sm:w-7 sm:h-7 text-[#76B900]" />
                    Analytics
                  </h2>
                  <p className="text-neutral-400 mb-4 sm:mb-6 leading-relaxed">
  ...
  "avgClicks": 285
                ...
                {/* Redirect */}
                <section id="redirect" className="mb-12 lg:mb-20 scroll-mt-20">
                  ...
                  >
                    ...
                    <ul className="space-y-2 text-xs sm:text-sm text-neutral-400 mb-4 sm:mb-6">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-[#76B900] mt-1">•</span>
                        <span>
                          Records analytics event (IP, device, browser,
                          referrer, geo)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
...
# Location: https://example.com`}
                    ...
                    <div className="border border-neutral-800 p-3 sm:p-4 mt-4 sm:mt-6 bg-[#0D0F13]">
                      <h5 className="text-xs font-medium text-neutral-300 mb-2">
                        Analytics Tracked Per Click
                      </h5>
                      <div className="grid grid-cols-2 gap-1 sm:gap-2 text-xs text-neutral-400">
                        <div>• IP Address</div>
                        <div>• User Agent</div>
                        <div>• Referrer</div>
                ...
                >
                  ...
                  <div className="border border-neutral-800 -mx-4 sm:mx-0 overflow-x-auto">
                    <table className="w-full text-xs sm:text-sm min-w-[500px]">
                      <thead>
                        <tr className="border-b border-neutral-800">
                          <th className="text-left py-3 px-2 sm:px-4 text-neutral-400 font-medium">
                            Tier
                          </th>
                          <th className="text-left py-3 px-2 sm:px-4 text-neutral-400 font-medium">
                            Links Limit
                      ...
                      <tbody>
                        <tr className="border-b border-neutral-800/50">
                          <td className="py-2 sm:py-3 px-2 sm:px-4 text-neutral-300">
                            Guest
                          </td>
                          <td className="py-2 sm:py-3 px-2 sm:px-4 text-neutral-400">
                            1 per session
                          </td>
                          <td className="py-2 sm:py-3 px-2 sm:px-4 text-neutral-400">
                            No authentication
                ...
                {/* Error Handling */}
                <section id="errors" className="mb-12 lg:mb-20 scroll-mt-20">
                  <h2 className="text-2xl sm:text-3xl font-light mb-4 sm:mb-6">
                    Error Handling
                  </h2>
                  <p className="text-neutral-400 mb-4 sm:mb-6 leading-relaxed">
                  ...
                  <div className="border border-neutral-800 mb-4 sm:mb-6 -mx-4 sm:mx-0 overflow-x-auto">
                    <table className="w-full text-xs sm:text-sm min-w-[500px]">
                      <thead>
                        <tr className="border-b border-neutral-800">
                          <th className="text-left py-2 sm:py-3 px-2 sm:px-4 text-neutral-400 font-medium">
                            Code
                          </th>
                ...
                <div className="sticky top-24">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="border border-neutral-800 p-4">
                      ...
                      <p className="text-xs text-neutral-400">
                        UA parsing for browser, OS, and device type
                        classification
                      </p>
                    </div>
