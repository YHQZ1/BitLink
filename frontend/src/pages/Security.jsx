    ...
    <div className="min-h-screen bg-[#0B0D10] text-[#F5F7FA]">
      ...
      <main className="pt-32 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto pb-12 lg:pb-20">
        ...
        <section className="mb-12 lg:mb-16">
          <h2 className="text-2xl sm:text-3xl font-light mb-6 lg:mb-8 flex items-center gap-3">
            <Shield className="w-5 h-5 sm:w-7 sm:h-7 text-[#76B900]" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div className="border border-neutral-800 p-4 sm:p-6">
              <div className="flex items-center gap-3 mb-3 sm:mb-4">
                <Lock className="w-5 h-5 sm:w-6 sm:h-6 text-[#76B900]" />
            ...
            <div className="border border-neutral-800 p-4 sm:p-6">
              <div className="flex items-center gap-3 mb-3 sm:mb-4">
                <Key className="w-5 h-5 sm:w-6 sm:h-6 text-[#76B900]" />
                <h3 className="text-base sm:text-lg font-medium">
                  Password Security
                </h3>
              </div>
            ...
            <div className="border border-neutral-800 p-4 sm:p-6">
              <div className="flex items-center gap-3 mb-3 sm:mb-4">
                <Database className="w-5 h-5 sm:w-6 sm:h-6 text-[#76B900]" />
                <h3 className="text-base sm:text-lg font-medium">
                  Data Protection
                </h3>
              </div>
            ...
            <div className="border border-neutral-800 p-4 sm:p-6">
              <div className="flex items-center gap-3 mb-3 sm:mb-4">
                <Server className="w-5 h-5 sm:w-6 sm:h-6 text-[#76B900]" />
                <h3 className="text-base sm:text-lg font-medium">
                  Infrastructure
                </h3>
              </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="border border-neutral-800 p-3 sm:p-4 bg-[#0D0F13]">
                ...
                <ul className="space-y-1 text-xs text-neutral-400 ml-3 sm:ml-4">
                  <li>
        ...
        <section className="mb-12 lg:mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div className="border border-neutral-800 p-4 sm:p-6">
              <div className="flex items-center gap-3 mb-3 sm:mb-4">
                <Eye className="w-5 h-5 sm:w-6 sm:h-6 text-[#76B900]" />
                <h3 className="text-base sm:text-lg font-medium">
                  Data Minimization
                </h3>
              </div>
          ...
          <div className="space-y-3">
            <div className="border border-neutral-800 p-3 sm:p-4">
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#76B900] flex-shrink-0 mt-0.5" />
                <div>
        ...
        <section className="border-t border-neutral-800 pt-8 sm:pt-12">
          ...
          <div className="border border-neutral-800 p-4 sm:p-6 bg-[#0D0F13] mb-4 sm:mb-6">
          ...
          <div className="border border-orange-400/20 bg-orange-400/5 p-3 sm:p-4">
            <div className="flex items-start gap-3">
