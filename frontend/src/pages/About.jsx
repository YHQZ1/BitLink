  ...
  return (
    <div className="min-h-screen bg-[#0B0D10] text-[#F5F7FA]">
      ...
      <main className="pt-32 px-5 md:px-8 max-w-4xl mx-auto pb-20">
        <h1 className="text-5xl font-light mb-6">About BitLink</h1>
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-light mb-8">Core Principles</h2>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="border border-neutral-800 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-medium">Security by Design</h3>
              </div>
              <p className="text-sm text-neutral-400">
            ...
            <div className="border border-neutral-800 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-medium">Built to Scale</h3>
              </div>
              <p className="text-sm text-neutral-400">
            ...
            <div className="border border-neutral-800 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-medium">Real Analytics</h3>
              </div>
              <p className="text-sm text-neutral-400">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-light mb-6">Technology Stack</h2>
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-light mb-6">Architecture Highlights</h2>
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-light mb-6">For Developers</h2>
          ...
          <button
            ...
            className="border border-[#76B900] text-[#76B900] px-6 py-3 hover:bg-[#76B900] hover:text-black transition-colors"
          >
        ...
        <section className="border-t border-neutral-800 pt-12">
          <h2 className="text-3xl font-light mb-6">Built With Purpose</h2>
          <p className="text-neutral-400 leading-relaxed mb-4">
